      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            {/* Thumbnail Gallery - ELIMINADO ya que solo tenemos una imagen */}
            {/* {images.length > 1 && (
          ...
          <div className="space-y-8">
            ...
            {/* Colors - CORREGIDO: usar 'color' en lugar de 'colors' */}
            {product.color && (
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex gap-2">
                  <span className="text-sm text-gray-600 px-3 py-1 border border-gray-200 rounded-full">
                    {product.color}
                  </span>
                </div>
              </div>
