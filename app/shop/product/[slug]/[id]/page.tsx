...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  const images = [product.image]; // Solo tenemos una imagen
  ...
  const handleAddToCart = async (): Promise<void> => {
    ...
    // TODO: Implementar add to cart
    console.log('Agregar al carrito:', product, selectedSize);
    setIsAdding(false);
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-3xl md:text-4xl font-light mb-3 tracking-tight capitalize">
                  {product.name}
                </h1>
              ...
              {product.material && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 capitalize">{product.material}</p>
                  </div>
                </div>
              )}
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex gap-2">
                  {product.colors.map((color, index) => (
                    <span key={index} className="text-sm text-gray-600 px-3 py-1 border border-gray-200 rounded-full capitalize">
                      {color}
                    </span>
                  ))}
                </div>
